...
The *Who writes what* list in `../../../plugins/dev/references/tech-debt.md` (under
`## Where things live`) scopes `## To Close` close-intents to `dev:spec`, while the one below was written at Build. The **decision** is still
