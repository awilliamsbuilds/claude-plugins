...
### Architecture-cycle design doesn't pressure-test cross-boundary delivery mechanisms
*First recorded: 2026-07-28 · Cycles: backlog-debt-model · Recurrence: 1*
...
**Files:** plugins/dev/skills/build/SKILL.md, plugins/dev/skills/plan/SKILL.md
...
*Closed 2026-07-25 by cycle state-write-mode-audit · First recorded: 2026-07-21 · Recurrence: 2*
